 ...
 -->
            <div class="media">
              ...
              <div class="media-body">
                ...
                <form action="{{route('salir')}}" method="POST">
                  @csrf
                  <button style="border-style: none;" class="btn btn-default" type="submit"><i class="fas fa-sign-out-alt "></i>Cerrar</button>
                </form>

              </div>
            </div>
          
          <a href="" hidden=""class="dropdown-item dropdown-footer">Config</a>
        </div>
      </li>
    </ul>
  </nav>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('dashboard')}}" class="brand-link">
      <img src="{{asset('images/descarga.jpg')}}" class="img-circle elevation-2" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8" width="40px" height="40px">
      <span class="brand-text font-weight-light">Grupo Izamal</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('images/descarga.jpg')}}" class="img-circle elevation-2" alt="User Image" width="40px" height="40px">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('puestos')}}" class="nav-link">
...
<!--     ///session hora actual saludo buenos dias -->
    ...
    <!-- Default to the left -->
    <strong>Copyright Grupo Izamal ® 2020<a href="https://grupoizamal.com/"> GrupoIzamal</a>.</strong>
