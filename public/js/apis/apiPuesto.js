...
new Vue({
    ...
    methods:{
        ...
        puesto_delete(id){
            ...
            var confir= confirm("Estas seguro de eliminar el registro?");
    ...
    filtrarPuesto:function(){
        //retorno el array de mascotas con un filtro (mascota), la cual sera aquel valor que se retornara
        //para definirle que de mascota me buscar el nombre, y luego me lo explotara a admitir palabras masyusculas, minisculas.
